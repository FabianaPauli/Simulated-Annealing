...
public class SimulatedAnnealing {
    ...
    public void execute(String fileName) {
        ...
        // Passando o fileName corretamente
    ...
    private void writeReport(String fileName) {
        try {
            // Corrigido para passar o fileName corretamente
            Files.write(Paths.get("report_" + fileName + ".csv"), builder.toString().getBytes(), StandardOpenOption.CREATE,
    ...
    private void generateGraphsTemperature(String fileName) {
        ...
        try {
            BitmapEncoder.saveBitmap(chart, "grafico_temperatura_" + fileName, BitmapEncoder.BitmapFormat.PNG);
        } catch (IOException e) {
    ...
    private void generateGraphsFitness(String fileName) {
        ...
        try {
            BitmapEncoder.saveBitmap(chart, "grafico_convergencia_" + fileName, BitmapEncoder.BitmapFormat.PNG);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }
